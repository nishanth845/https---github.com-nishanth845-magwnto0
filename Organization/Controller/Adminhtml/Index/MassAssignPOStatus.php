<?php
/*
 * Filename     : MassAssignPOStatus.php
 * Developer    : Alexander
 * Company      : AHA
...
/**
 * Class MassAssignPOStatus
 */
class MassAssignPOStatus extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $organization) {
            ...
            $organization->setPoStatus($this->getRequest()->getParam('id'))->save();
            $orgUpdated++;
        }
